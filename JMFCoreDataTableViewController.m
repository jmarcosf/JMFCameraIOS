...
/*               CoreData TableView Controller Class implemantation file   */
/*                                                                         */
...
- (void)performFetch
{
    if( self.fetchedResultsController )
    {
        ...
        {
            if( self.bDebug ) NSLog( @"[%@ %@] fetching %@ with predicate: %@",
        ...
        {
            if( self.bDebug ) NSLog( @"[%@ %@] fetching all %@ (i.e., no predicate)",
                                     NSStringFromClass( [self class] ),
                                     NSStringFromSelector( _cmd ),
                                     self.fetchedResultsController.fetchRequest.entityName );
        }
    ...
    {
        if( self.bDebug ) NSLog( @"[%@ %@] no NSFetchedResultsController (yet?)",
                                 NSStringFromClass( [self class]) ,
                                 NSStringFromSelector( _cmd ) );
    }
...
- (void)setFetchedResultsController:(NSFetchedResultsController*)newFetchedResultsController
{
    ...
    if( newFetchedResultsController != oldFetchedResultsController )
    {
        ...
        {
            if( self.bDebug ) NSLog( @"[%@ %@] reset to nil",
                                     NSStringFromClass( [self class] ),
                                     NSStringFromSelector( _cmd ) );
            [self.tableView reloadData];
        }
